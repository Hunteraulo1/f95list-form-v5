...
<div class="flex flex-col gap-4">
	<section class="grid grid-cols-2 gap-4">
		<a
			...
			class="bg-base-100 p-4 rounded-xl relative flex items-center justify-between"
		>
			<div>
	...
	<section class="bg-base-100 p-4 rounded-xl flex flex-col gap-2">
					...
					>
						<span class="flex items-center gap-2 min-w-0">
							<img
								...
								class="size-10 rounded-lg object-cover shrink-0 bg-base-200"
							/>
							<span class="truncate">{game.name}</span>
						</span>
						<span
							class="text-xs font-bold uppercase px-2 py-1 rounded-lg shrink-0"
							...
							class:text-warning-content={game.translationStatus ===
								"outdated"}
